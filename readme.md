...
This will create an executable jar file **tracing-demo.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/tracing-demo.jar
